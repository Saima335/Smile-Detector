...
def output(request):
    face_detector=cv2.CascadeClassifier('C:\\Users\\ATTA UR REHMAN\\Desktop\\AI Final Project\\DjangoTRY (1)\\DjangoTRY\\buttons\\buttons\\haarcascade_frontalface_default.xml')
    smile_detector=cv2.CascadeClassifier('C:\\Users\\ATTA UR REHMAN\\Desktop\\AI Final Project\\DjangoTRY (1)\\DjangoTRY\\buttons\\buttons\\haarcascade_smile.xml')
